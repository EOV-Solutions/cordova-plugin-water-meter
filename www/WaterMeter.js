...
var WaterMeter = {
     ...
     * 
     * @param {string|Object} options - License key string or options object
    * @param {string} options.license - License key from backend
    * @param {string} [options.licenseKey] - Legacy alias for license
     * @param {Object} [options.metadataInfo] - Optional metadata to send to server (for admin tracking)
     * @param {string} [options.deviceUser] - Optional device user string (for admin tracking)
     * @param {Function} success - Success callback
     * @param {Function} error - Error callback
     * 
     * @example
     * // Simple usage with just license key
     ...
     * 
     * @example
     * // With metadata and device user
     * WaterMeter.initializeLicense(
     *     {
    *         license: 'YOUR_LICENSE_KEY',
     *         metadataInfo: { location: 'Store A', customerId: '12345' },
     *         deviceUser: 'employee@company.com'
     *     },
     *     function(result) { console.log('SDK initialized:', result); },
     *     function(err) { console.error('License error:', err); }
     * );
     ...
     * 
     * @param {string} text - Raw reading text (e.g., "001244")
     * @returns {string} Formatted reading (e.g., "1244")
     */
    formatReading: function (text) {
        if (!text) return text;
