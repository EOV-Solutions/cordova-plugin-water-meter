...
var WaterMeter = {
    ...
    /**
     * Open camera scanner (Alias for scan)
     * Matches the test app usage: startCamera(options, success, error)
     */
    startCamera: function (options, successCallback, errorCallback) {
        // Swap arguments if needed to call scan logic
        this.scan(successCallback, errorCallback, options);
    },
